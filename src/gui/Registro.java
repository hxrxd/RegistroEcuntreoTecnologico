...
public class Registro extends javax.swing.JFrame {
     ...
     */
    public Registro() {
        super("II Encuentro Tecnológico");
        initComponents();
        this.setLocationRelativeTo(null);
        Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/img/registro.png"));
        setIconImage(icon);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {
        PanelEncuentro p = new PanelEncuentro();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("CUNOC/VISITANTE");
        ...
        jLabel5.setText("Selecciona Tu Carrera");
        ...
        mCheckBox.setText("Ingeniería Mecánica");
        ...
        partakerPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, partakerPanelLayout.createSequentialGroup()
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/logo2.png"))); // NOI18N
    ...
    public void regVisitant(){
        if(nameTextField.getText().equals("")||emailTextField.getText().equals("")){
            ...
            String is="No",ic = "No",ii="No",im="No";
            ...
            this.clean();
            JOptionPane.showMessageDialog(this, "Bienvenid@, ponte comodo ya empezamos!","Bienvenido",JOptionPane.INFORMATION_MESSAGE);
